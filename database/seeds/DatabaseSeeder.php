    ...
    public function run()
    {
    	...
    	[
	    	[
				...
				'years_exp'=>10,
				'status'=>'pending',
				'date_applied'=>Carbon::create(2018, 06, 05, 11, 55, 42, new DateTimeZOne('UTC')),
				'reviewed'=>false,
	    	...
	    	[
				...
				'years_exp'=>13,
				'status'=>'accepted',
				'date_applied'=>Carbon::create(2018, 06, 02, 9, 55, 42, new DateTimeZOne('UTC')),
				'reviewed'=>true,
	    	...
	    	[
				...
				'years_exp'=>15,
				'status'=>'pending',
				'date_applied'=>Carbon::create(2018, 05, 05, 11, 55, 42, new DateTimeZOne('UTC')),
				'reviewed'=>false,
				'description'=>'',
	    	],
	    	...
	    	[
				...
				'years_exp'=>1,
				'status'=>'pending',
				'date_applied'=>Carbon::create(2018, 04, 30, 21, 55, 42, new DateTimeZOne('UTC')),
				'reviewed'=>false,
    	...
    	foreach($records as $record) {
    		...
    		$record = Candidate::firstOrCreate($record);
